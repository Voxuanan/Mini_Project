...
Object.keys(LANGUAGE_BY_LOCALE).forEach((item) => {
    let option = document.createElement("option");
    option.value = item;
    option.innerHTML = LANGUAGE_BY_LOCALE[item];
    if (item == "en_US") option.selected = true;
...
const refreshBtn = document.querySelectorAll(".btn .fas")[0];
const micBtn = document.querySelectorAll(".btn .fas")[1];
...
if (speechRecognition) {
    ...
    refreshBtn.addEventListener("click", (e) => {
        ...
        searchInput.focus();
        console.log("Speech Recognition Supported 111");
    });
    ...
    recognition.addEventListener("start", () => {
        ...
        searchInput.focus();
        console.log("Speech Recognition Enable");
    });
    ...
    recognition.addEventListener("end", () => {
        ...
        searchInput.focus();
        console.log("Speech Recognition Disable");
    });
